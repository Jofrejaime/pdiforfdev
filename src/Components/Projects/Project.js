...
import Denunciar from "./Denunciar/Denunciar";
function Project({ project, setModalProject, setView }) {
  ...
  const [starred, setStared] = useState(faStar);
  useEffect(() => {
    if (logedUser) {
      const starredByUser = star.find((star) => star.userId === logedUser.id);
      if (starredByUser) setStared(faStar);
                ...
                <img
                  src={
                    ...
                    project.files.find((file) =>
                      img.some((ext) => file.endsWith(ext))
                    )
                  }
                ...
                <div className={styles.projectOptions}>
                  ...
                  >
                    ...
                    <div className={styles.option}>
                      <Denunciar project={project.project.id} />
                    </div>
                  </span>
                </div>
                  ...
                  <div className={styles.profileUser}>
                    <span>
                      <span className={styles.Avatar}>
                        <img
                          src={
                            filesUrl + project.project.user.profile.photo_url
                          }
                          alt={project.project.title}
                        />
                      </span>
                      <NavLink to={`${project.project.user.userName}`}>
